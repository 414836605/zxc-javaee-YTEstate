...
<script src="${path }/third/xlsx/xlsx.core.min.js"></script>
<script src="${path }/third/xlsx/blob.js"></script>
<script src="${path }/third/xlsx/FileSaver.min.js"></script>
<script src="${path }/third/xlsx/tableexport.min.js"></script>
</head>
<body>
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div>
				<a href="${path }/statistics/download_income.action"
		...
		var table = $('#sample-table').DataTable(
				{
					...
					"serverSide" : true,
					"ajax" : {
						"url" : '${path }/statistics/page_fee.action',
