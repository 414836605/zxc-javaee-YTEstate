...
<body>
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div class="w-400">
				<h2 style="text-align: center">添加楼宇信息</h2>
				<form id="valid_form" class="form-horizontal" action="${path }/build/insert.action">
					<div class="form-group">
						<label class="col-sm-4 control-label">楼宇类型</label>
						<div class="col-sm-8">
							<input type="text" name="buildType" class="form-control" placeholder="楼宇类型"></div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">楼宇面积</label>
						<div class="col-sm-8">
							<input type="text" name="buildArea" class="form-control" placeholder="楼宇面积"></div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">楼宇费用</label>
						<div class="col-sm-8">
							<input type="text" name="buildFee" class="form-control" placeholder="楼宇费用"></div>
					</div>
					<div class="form-group">
