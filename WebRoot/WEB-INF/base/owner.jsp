...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<div>
			<a class="btn btn-success" href="${path }/owner/addPage.action">添加业主信息</a>
		</div>
	</div>
</div>
    ...
    "columns": [
           ...
           { 
            ...
            "render": function(data) {
            	var eidthref = '${path }/owner/updatePage.action?data='+data;
            	//var delhref = '${path }/owner/delete/'+data;
...
$.confirm({
    ...
    confirm: function(){
    	var delhref = '${path }/owner/delete.action';
    	$.post(delhref, {ownerId:data},function(data){
    		if (data == '1') {
