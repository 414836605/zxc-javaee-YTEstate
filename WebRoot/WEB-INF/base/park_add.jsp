	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div class="w-400">
				...
				<form id="valid_form" class="form-horizontal" action="${path }/park/insert.action">
					<div class="form-group">
						<label class="col-sm-4 control-label">车位面积</label>
						<div class="col-sm-8">
							<input type="text" name="parkArea"  class="form-control" placeholder="车位面积"></div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">车位费用</label>
						<div class="col-sm-8">
							<input type="text"  name="parkFee" class="form-control" placeholder="车位费用"></div>
					</div>
