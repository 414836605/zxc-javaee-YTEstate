...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<div>
			<a href="${path }/build/addPage.action" class="btn btn-success">增加楼宇信息</a>
		</div>
	</div>
</div>
    ...
    "columns": [
           ...
           { 
            ...
            "render": function(data) {
            	var eidthref = '${path }/build/updatePage.action?data='+data;
...
$.confirm({
    ...
    confirm: function(){
    	var delhref = '${path }/build/delete.action';
    	$.post(delhref, {buildId:data},function(data){
    		if (data == '1') {
