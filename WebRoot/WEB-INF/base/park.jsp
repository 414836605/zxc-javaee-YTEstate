...
<div class="panel panel-success">
	...
	<div class="panel-body">
					...
					<tr>
						...
						<td>
							<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
								...
								<a class="green" href="park_update.html">
		...
		<div>
			<a href="${path }/park/addPage.action" class="btn btn-success">添加车库信息</a>
		</div>
	</div>
</div>
    ...
    "columns": [
           ...
           { 
            ...
            "render": function(data) {
            	var eidthref = '${path }/park/updatePage.action?data='+data;
...
$.confirm({
    ...
    confirm: function(){
    	var delhref = '${path }/park/delete.action';
    	$.post(delhref, {parkId:data},function(data){
    		if (data == '1') {
